...
<script setup>
import { getInvestmentRecordList } from '~/api/user';
...
const getRecordList = async () => {
  try {
    const {total, list} = await getInvestmentRecordList({...queryParams, pageNum: queryParams.pageNum + 1});
